...
{
    public partial class frm_rpt_HopDong : Form
    {
        public frm_rpt_HopDong(string id)
        {
            InitializeComponent();
            this.id = id;
            LoadRpt();
        ...
        private void frm_rpt_HopDong_Load(object sender, EventArgs e)
        {
        }
    }
}
