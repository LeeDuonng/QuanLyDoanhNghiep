...
{
    public partial class frm_rpt_TraCongNo : Form
    {
        public frm_rpt_TraCongNo()
        {
            InitializeComponent();
            LoadRpt();
        }
        ...
        private void LoadRpt()
        {
            ...
            this.reportViewer1.LocalReport.ReportPath = "./rptTraCongNo.rdlc";
        ...
        private void frm_rpt_TraCongNo_Load(object sender, EventArgs e)
        {
